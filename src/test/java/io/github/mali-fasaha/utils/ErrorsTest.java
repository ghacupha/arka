...
import org.mali.fasaha.utils.Errors.Plugins.Dialog;
import org.mali.fasaha.utils.Errors.Plugins.Log;
...
public class ErrorsTest {
	...
	public void testWiresCrossed() {
		...
		Plugins.register(Log.class, new TestHandler("Log"));
		Plugins.register(Dialog.class, new TestHandler("Dialog"));
