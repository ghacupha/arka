...
public class ErrorsTest {
	...
	public void testWiresCrossed() {
		...
		Plugins.register(Errors.Plugins.Log.class, new TestHandler("Log"));
		Plugins.register(Errors.Plugins.Dialog.class, new TestHandler("Dialog"));
	...
	public static class TestHandler implements Errors.Plugins.Log, Errors.Plugins.Dialog {
