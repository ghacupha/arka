...
import io.github.mali.fasaha.utils.Errors;
import io.github.mali.fasaha.utils.Plugins;
import io.github.mali.fasaha.utils.Throwing;
...
public class ErrorsExample {
	...
	public void whereDoLogAndDialogComeFrom() {
		...
		Plugins.register(Errors.Plugins.Log.class, error -> {
			// log to twitter
		});
		Plugins.register(Errors.Plugins.Dialog.class, error -> {
	...
	public void wrapping() {
		...
		Runnable marathonSafe = Errors.log().wrap(marathon);
