...
public abstract class Errors implements Consumer<Throwable> {
     ...
     * @return a {@link Errors.Handling} object.
     */
     ...
     * @return a {@link Errors.Rethrowing} object.
     */
     ...
     *
     * @see io.github.mali.fasaha.utils.Plugins
    ...
    public static Handling log() {
        if (log == null) {
            ...
            log = createHandling(io.github.mali.fasaha.utils.Plugins.get(Plugins.Log.class, Errors.Plugins::defaultLog));
        }
        return log;
    }
    ...
    public static Handling dialog() {
        if (dialog == null) {
            ...
            dialog = createHandling(io.github.mali.fasaha.utils.Plugins.get(Plugins.Dialog.class, Errors.Plugins::defaultDialog));
        }
        return dialog;
    }
     ...
     *
     * @param runnable a {@link Throwing.Runnable} object.
     */
     ...
     *
     * @param consumer a {@link Throwing.Consumer} object.
     * @return a {@link java.util.function.Consumer} object.
     * @param <T> a T object.
     */
     ...
     */
    public java.util.function.IntConsumer wrapIntConsumer(Throwing.IntConsumer consumer) {
        return val -> {
            try {
                consumer.accept(val);
            } catch (Throwable e) {
