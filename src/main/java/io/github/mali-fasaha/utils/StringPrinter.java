 ...
 * <p>
 * Can present itself as an {@link java.io.OutputStream}, {@link java.io.PrintStream}, {@link java.io.Writer}, or {@link java.io.PrintWriter}.
 *
 * @author edwin_njeru
 * @version $Id: $Id
 */
public class StringPrinter {
     ...
     *
     * @param printer a {@link java.util.function.Consumer} object.
    ...
    /**
     * Given a consumer of lines, creates a stateful consumer of strings which will combine its input until it finds a newline, and split its input when it contains multiple newlines.  Examples make
     * this more clear:
     * <pre>
     * {@code
     * "some", "\n", "simple ", "lines", "\n" -> "some", "simple lines"
     ...
     * </pre>
     *
     * @param perLine {@code Consumer<String>} which will receive strings which were terminated by newlines but are not anymore.
     * @return {@code Consumer<String>} which accepts any strings, and will feed them to perLine.
     */
    ...
    /**
     * Returns a StringPrinter for {@link java.lang.System#out}.
     *
     * @return a {@link org.mali.fasaha.utils.StringPrinter} object.
     */
    ...
    /**
     * Returns a StringPrinter for {@link java.lang.System#err}.
     *
     * @return a {@link org.mali.fasaha.utils.StringPrinter} object.
     */
    ...
    /**
     * Creates an OutputStream which will print its content to the given StringPrinter, encoding bytes according to the given Charset. Doesn't matter if you close the stream or not, because
     * StringPrinter doesn't have a close().
     * <p>
        ...
        return new Writer() {
            ...
            private String toStringSafely(CharSequence csq) {
                ...
                if (asString.length() == csq.length()) {
                    ...
                    Errors.log()
                          .accept(new IllegalArgumentException(csq.getClass() + " did not implement toString() correctly."));
