 ...
 * <p>
 * <code>IPlugin instance = Plugins.get(IPlugin.class, defaultImplementation);</code>
 * <p>
 * Once someone has requested a class from Plugins, whatever instance was returned will continue to be returned for every future call. This has the same behavior as if you declared a <code>public
 * static final IPlugin</code>.
 * <p>
 * Before the value has been requested, it can be set programmatically using {@link #register}, or by setting a system property.  This allows setting global behaviors appropriate for diverse
 * environments.
 * <p>
 ...
 * the fully-qualified name (<code>Class.getName()</code>) of an implementation class with a no-argument constructor, then an instance of that class will be instantiated and used as the plugin
 * implementation
 * <li> the <code>defaultImplementation</code> that was specified in the first call to get()
 * </ol>
 * <p>
 * This class was inspired by <a href="https://github.com/ReactiveX/RxJava/blob/86147542573004f4df84d2a2de83577cf62fe787/src/main/java/rx/plugins/RxJavaPlugins.java">RxJava's RxJavaPlugins</a>. Many
 * thanks to them!
 *
...
public final class Plugins {
     ...
     * @throws java.lang.IllegalStateException If called more than once or if a value has already been requested.
