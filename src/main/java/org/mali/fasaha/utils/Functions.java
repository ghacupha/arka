...
/**
 * Helper functions for manipulating {@link java.util.function.Function}, copied from Guava.
 * <p>
...
public final class Functions {
    ...
    /**
     * Returns a function which performs a map lookup. The returned function throws an {@link java.lang.IllegalArgumentException} if given a key that does not exist in the map. See also
     * {@link #forMap(Map)}, which returns a default value in this case.
     *
    ...
    /**
     * Returns a function which performs a map lookup with a default value. The function created by this method returns {@code defaultValue} for all inputs that do not belong to the map's key set. See
     * also {@link #forMap(Map)}, which throws an exception in this case.
     *
    ...
    /**
     * Returns the composition of two functions. For {@code f: A->B} and {@code g: B->C}, composition is defined as the function h such that {@code h(a) == g(f(a))} for each {@code a}.
     *
    ...
    /**
     * Returns a function that always returns the result of invoking {@link java.util.function.Supplier#get} on {@code supplier}, regardless of its input.
     *
     * @since 10.0
