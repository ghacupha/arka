...
public class TreeNode<T> {
     ...
     *
     * @param parent a {@link org.mali.fasaha.utils.TreeNode} object.
     ...
     * @return a {@link org.mali.fasaha.utils.TreeNode} object.
     * @param <T> a T object.
     */
    ...
    /**
     * Creates a hierarchy of TreeNodes that copies the structure and content of the given tree, using {@code mapper} to calculate the content of the nodes.
     *
     * @param treeDef a {@link org.mali.fasaha.utils.TreeDef} object.
     * @param root a T object.
    ...
    /**
     * {@link org.mali.fasaha.utils.TreeDef.Parented} for TreeNodes.
     *
     * @return a {@link org.mali.fasaha.utils.TreeDef.Parented} object.
     * @param <T> a T object.
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param testData a {@link java.lang.String} object.
     * @return a {@link org.mali.fasaha.utils.TreeNode} object.
     */
    ...
    public String toStringDeep() {
        return TreeQuery.toString(treeDef(), this, node -> node.getContent()
                                                               .toString());
    }
     ...
     *
     * @throws java.lang.IllegalArgumentException if no such node exists
     * @param path a T object.
     * @return a {@link org.mali.fasaha.utils.TreeNode} object.
     */
    @SuppressWarnings("unchecked")
    ...
    public TreeNode<T> findByContent(T content) {
        Optional<TreeNode<T>> opt = TreeStream.breadthFirst(treeDef(), this)
