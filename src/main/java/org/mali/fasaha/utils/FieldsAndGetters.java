...
public class FieldsAndGetters {
     ...
     * <p>
     * This method uses reflection to find all of the public instance fields of the given object, and if they pass the given predicate, it includes them in a stream of {@code Map.Entry<Field, Object>}
     ...
     * <p>
     * This method uses reflection to find all of the public instance methods which don't take any arguments and return a value.  If they pass the given predicate, then they are called, and the return
     * value is included in a stream of {@code Map.Entry<Method, Object>}.
     * <p>
     * Note that there are some methods which have the signature of a getter, but actually mutate the object being inspected, e.g. {@link java.io.InputStream#read()}.  These will be called unless you
     * manually exclude them using the predicate.
     *
     * @param obj a {@link java.lang.Object} object.
     * @param predicate a {@link java.util.function.Predicate} object.
     * @return a {@link java.util.stream.Stream} object.
     ...
     * <p>
     * This method combines the results of {@link #fields(Object, Predicate)} and {@link #getters(Object, Predicate)}. The {@code Predicate<String>} will be passed the field names and the getter names
     * (which are postfixed by {@code ()} to mark them as methods).
     *
     * @see #fields(Object, Predicate)
     * @see #getters(Object, Predicate)
     * @see #fields(Object, Predicate)
    ...
    public static Stream<Map.Entry<String, Object>> fieldsAndGetters(Object obj, Predicate<String> predicate) {
        Stream<Map.Entry<String, Object>> fields = fields(obj, field -> predicate.test(field.getName())).map(entry -> createEntry(entry.getKey()
                                                                                                                                       .getName(), entry.getValue()));
        Function<Method, String> methodName = method -> method.getName() + "()";
        Stream<Map.Entry<String, Object>> getters = getters(obj, field -> predicate.test(methodName.apply(field))).map(entry -> createEntry(methodName.apply(entry.getKey()), entry.getValue()));
     ...
     * @param obj a {@link java.lang.Object} object.
     * @param evalPredicate a {@link java.util.function.Predicate} object.
     * @param dumpPredicate a {@link java.util.function.Predicate} object.
     * @param printer a {@link org.mali.fasaha.utils.StringPrinter} object.
     */
    public static void dumpIf(String name, Object obj, Predicate<String> evalPredicate, Predicate<Map.Entry<String, Object>> dumpPredicate, StringPrinter printer) {
        printer.println(name + ": " + obj.getClass()
                                         .getName());
        fieldsAndGetters(obj, evalPredicate).filter(dumpPredicate)
                                            .forEach(entry -> {
